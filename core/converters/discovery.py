...
eklemek — `ui_qml/bridge/app_bridge.py`'ye dokunmaya gerek kalmaz
(tak-çıkar mimari). Bu paketin `__init__.py` içermesi PyInstaller
paketlemesi için zorunlu (bkz. docs/wiki/paketleme.md).
